...
class BigBuyClient{
    ...
    public function productInformationSku($id){
        $headers = ['Content-Type' => 'application/json', 'Authorization' => 'Bearer ' . $this->token];

        $request = new Request('GET', "/rest/catalog/productinformationbysku/$id.json?isoCode=nl", $headers);
        $response = $this->client->send($request);
    ...
    public function product($id){
        ...
        $request = new Request('GET', "/rest/catalog/product/$id.json?isoCode=nl", $headers);
        $response = $this->client->send($request);
    ...
    public function productStock($id){
        ...
        $request = new Request('GET', "/rest/catalog/productstock/$id.json?isoCode=nl", $headers);
        $response = $this->client->send($request);
